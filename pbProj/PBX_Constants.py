...
kPBX_REFERENCE_sourceTree_Group = '<group>'
kPBX_REFERENCE_sourceTree_Absolute = '<absolute>'
kPBX_REFERENCE_sourceTree_SourceRoot = 'SOURCE_ROOT'
kPBX_REFERENCE_sourceTree_DeveloperDir = 'DEVELOPER_DIR'
kPBX_REFERENCE_sourceTree_BuiltProducts = 'BUILT_PRODUCTS_DIR'
kPBX_REFERENCE_sourceTree_SDKRoot = 'SDKROOT'
